...
const THROW_NADE_MININTERVAL = 8;
...
const THROW_MOLOTOV_MININTERVAL = 8;
...
const BOT_PICKUP_RANGE2 = 80; // when Settings.pickup_animation = 1

// Survivor bot's max scan range for dead survivors to defib
const BOT_GOTODEFIB_RANGE = 400;
...
const SHOVE_COMMON_DELTAPITCH = -8;
...
const PROXIMITY_RANGE_MAX = 3000;
